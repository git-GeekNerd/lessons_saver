...
3. **Использование**
    - Перейдите в папку проекта с помощью командной строки и выполните следующую команду:
        ```bash
        python lessons_saver.py
        ```
    - Это запустит программу. Вы также можете запустить программу, кликнув по файлу `start.bat`.
